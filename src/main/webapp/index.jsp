            ...
            <ul class="layui-nav right" lay-filter="">
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <!-- 二级菜单 -->
                        <dd>
                            <a onclick="xadmin.open('个人信息','./admin-add.html')">个人信息</a></dd>
                        <dd>
                            <a onclick="xadmin.open('切换帐号','https://www.baidu.com')">修改密码</a></dd>
                        <dd>
